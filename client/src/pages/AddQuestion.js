            ...
            <div className="container">
                <div className="add">
                    ...
                    <form>
                        ...
                        <button type="submit" className="btn hvr-grow" style={{backgroundColor: "yellow"}}onClick={this.handleFormSubmit}><Link style={{color: "black"}}className="nav-link" to="/addquestion">Submit</Link></button>
                    </form>
                </div>
            </div>
        )
